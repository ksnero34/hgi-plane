...
export class WorkflowService extends APIService {
  ...
  async activateWorkflow(workspaceSlug: string, projectId: string, workflowId: string): Promise<void> {
    return this.post(`/api/workspaces/${workspaceSlug}/projects/${projectId}/workflows/${workflowId}/activate/`, {})
      .then((response) => response?.data);
  }

  async deactivateWorkflow(workspaceSlug: string, projectId: string, workflowId: string): Promise<void> {
    return this.post(`/api/workspaces/${workspaceSlug}/projects/${projectId}/workflows/${workflowId}/deactivate/`, {})
      .then((response) => response?.data);
  }
  ...
  async getWorkflowStates(
    ...
    return this.get(`/api/workspaces/${workspaceSlug}/projects/${projectId}/workflows/${workflowId}/states/`)
      .then((response) => response?.data);
  }
  ...
  async updateWorkflowState(
    ...
    return this.patch(`/api/workspaces/${workspaceSlug}/projects/${projectId}/workflows/${workflowId}/states/${stateId}/`, data)
      .then((response) => response?.data);
  }
  ...
  async deleteWorkflowState(
    ...
    return this.delete(`/api/workspaces/${workspaceSlug}/projects/${projectId}/workflows/${workflowId}/states/${stateId}/`)
      .then((response) => response?.data);
  }
  ...
  async getWorkflowTransitions(
    ...
    return this.get(`/api/workspaces/${workspaceSlug}/projects/${projectId}/workflows/${workflowId}/transitions/`)
      .then((response) => response?.data);
  }
  ...
  async createWorkflowTransition(
    ...
    return this.post(`/api/workspaces/${workspaceSlug}/projects/${projectId}/workflows/${workflowId}/transitions/`, data)
      .then((response) => response?.data);
  }
  ...
  async updateWorkflowTransition(
    ...
    return this.patch(`/api/workspaces/${workspaceSlug}/projects/${projectId}/workflows/${workflowId}/transitions/${transitionId}/`, data)
      .then((response) => response?.data);
  }
  ...
  async deleteWorkflowTransition(
    ...
    return this.delete(`/api/workspaces/${workspaceSlug}/projects/${projectId}/workflows/${workflowId}/transitions/${transitionId}/`)
      .then((response) => response?.data);
  }
  ...
  async getWorkflowAssignmentRules(
    ...
    return this.get(`/api/workspaces/${workspaceSlug}/projects/${projectId}/workflows/${workflowId}/assignment-rules/`)
      .then((response) => response?.data);
  }
  ...
  async createWorkflowAssignmentRule(
    ...
    return this.post(`/api/workspaces/${workspaceSlug}/projects/${projectId}/workflows/${workflowId}/assignment-rules/`, data)
      .then((response) => response?.data);
  }
  ...
  async updateWorkflowAssignmentRule(
    ...
    return this.patch(`/api/workspaces/${workspaceSlug}/projects/${projectId}/workflows/${workflowId}/assignment-rules/${ruleId}/`, data)
      .then((response) => response?.data);
  }
  ...
  async deleteWorkflowAssignmentRule(
    ...
    return this.delete(`/api/workspaces/${workspaceSlug}/projects/${projectId}/workflows/${workflowId}/assignment-rules/${ruleId}/`)
      .then((response) => response?.data);
  }
  ...
  async validateTransition(
    ...
    return this.post(`/api/workspaces/${workspaceSlug}/projects/${projectId}/workflows/validate-transition/`, data)
      .then((response) => response?.data);
  }

  async executeTransition(workspaceSlug: string, projectId: string, data: IWorkflowValidation): Promise<void> {
    return this.post(`/api/workspaces/${workspaceSlug}/projects/${projectId}/workflows/execute-transition/`, data)
      .then((response) => response?.data);
  }

  // Approval request methods
  async requestApproval(workspaceSlug: string, projectId: string, data: IWorkflowValidation): Promise<any> {
    return this.post(`/api/workspaces/${workspaceSlug}/projects/${projectId}/workflows/request-approval/`, data)
      .then((response) => response?.data);
  }

  async approveTransition(workspaceSlug: string, projectId: string, approvalRequestId: string, data: { comment?: string }): Promise<void> {
    return this.post(`/api/workspaces/${workspaceSlug}/projects/${projectId}/workflows/approve-transition/${approvalRequestId}/`, data)
      .then((response) => response?.data);
  }
