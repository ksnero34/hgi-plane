...
CELERY_IMPORTS = (
    ...
    # import task
    "plane.bgtasks.import_task",
    # java notification task
    "plane.bgtasks.java_notification_task",
)

FILE_SIZE_LIMIT = int(os.environ.get("FILE_SIZE_LIMIT", 5368709120))
...
DATA_UPLOAD_MAX_MEMORY_SIZE = int(os.environ.get("FILE_SIZE_LIMIT", 5368709120))
...
# 세션 보안 설정
SESSION_IP_CHECK = os.environ.get("SESSION_IP_CHECK", "1") == "1"

# Admin Cookie
ADMIN_SESSION_COOKIE_NAME = "admin-session-id"
ADMIN_SESSION_COOKIE_AGE = int(os.environ.get("ADMIN_SESSION_COOKIE_AGE", 1800))
