...
class Project(BaseModel):
    ...
    overview = models.TextField(verbose_name="Project Overview", blank=True, null=True)
    overview_text = models.JSONField(verbose_name="Project Overview RT", blank=True, null=True)
    overview_html = models.JSONField(verbose_name="Project Overview HTML", blank=True, null=True)
