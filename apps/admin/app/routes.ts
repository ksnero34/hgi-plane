...
export default [
  ...
  layout("./(all)/(dashboard)/layout.tsx", [
    ...
    route("file-settings", "./(all)/(dashboard)/file-settings/page.tsx"),
    route("members", "./(all)/(dashboard)/members/page.tsx"),
    route("notification-settings", "./(all)/(dashboard)/notification-settings/page.tsx"),
    route("project-management", "./(all)/(dashboard)/project-management/page.tsx"),
    route("workspace-config", "./(all)/(dashboard)/workspace-config/page.tsx"),
  ]),
