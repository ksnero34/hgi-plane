...
# 이미지 목록
IMAGES=(
    "harbor.hwgeneralins.com/plane/api:0.0.7"
    "harbor.hwgeneralins.com/plane/worker:0.0.7"
    "harbor.hwgeneralins.com/plane/beat-worker:0.0.7"
    "harbor.hwgeneralins.com/plane/migrator:0.0.7"
)
