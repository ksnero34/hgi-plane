...
export const CustomAnalyticsSelectBar: React.FC<Props> = observer((props) => {
  ...
  return (
    ...
    >
      {!isProjectLevel && (
        <div>
          <h6 className="text-xs text-custom-text-200 mb-2">프로젝트</h6>
          <Controller
            name="project"
            control={control}
      ...
      <div>
        <h6 className="text-xs text-custom-text-200 mb-2">측정치 (y-축)</h6>
        <Controller
          name="y_axis"
          control={control}
      ...
      <div>
        <h6 className="text-xs text-custom-text-200 mb-2">기준치 (x-축)</h6>
        <Controller
          name="x_axis"
          control={control}
          render={({ field: { value, onChange } }) => (
      ...
      <div>
        <h6 className="text-xs text-custom-text-200 mb-2">그룹</h6>
        <Controller
          name="segment"
          control={control}
          render={({ field: { value, onChange } }) => (
