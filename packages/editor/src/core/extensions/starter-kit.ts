...
export const CustomStarterKitExtension = (args: TArgs) => {
  ...
  return StarterKit.configure({
    ...
    dropcursor: {
      class:
        "text-custom-text-300 transition-all motion-reduce:transition-none motion-reduce:hover:transform-none duration-200 ease-&lsqb;cubic-bezier(0.165, 0.84, 0.44, 1)&rsqb;",
    },
