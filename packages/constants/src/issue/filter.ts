...
export const ISSUE_DISPLAY_FILTERS_BY_PAGE: TIssueFiltersToDisplayByPageType = {
  profile_issues: {
    filters: ["priority", "state_group", "label_id", "start_date", "target_date", "issue_type_id", "search"],
    layoutOptions: {
      list: {
  ...
  sub_work_items: {
    filters: ["priority", "state_id", "assignee_id", "start_date", "target_date", "issue_type_id", "search"],
    layoutOptions: {
      list: {
