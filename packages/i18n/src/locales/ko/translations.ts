export default {
  ...
  common: {
    ...
    authorizing: "인증 중",
    processing: "처리 중",
    top_level_only: "최상위 작업항목만",
    per_page: "한번에 보일 작업항목 수",
    per_page_options: {
      "25": "25개",
      "50": "50개",
      "100": "100개",
  ...
  issue: {
    ...
    upload: {
      button: "작업 항목 가져오기",
      title: "작업 항목 가져오기",
      description: "CSV 또는 Excel 파일을 업로드하여 작업 항목을 가져옵니다.",
      select_file: "파일 선택",
      uploading: "업로드 중",
      success: "작업 항목을 성공적으로 가져왔습니다.",
      error: "작업 항목 가져오기 중 오류가 발생했습니다.",
    },
    bulk_edit: {
      label: "일괄 편집",
      success_suffix: "개 작업 항목이 성공적으로 업데이트되었습니다.",
      skipped_suffix: "개 작업 항목은 권한이 없어 건너뛰었습니다.",
      error_prefix: "업데이트 중 오류가 발생했습니다",
    },
  ...
  user_roles: {
    ...
    hgi_itpm: "IT PM",
    hgi_it: "IT",
    hgi_vendor_pl: "수행사 PL",
    hgi_business_stakeholder: "현업",
    hgi_vendor_pm: "수행사 PM",
    hgi_vendor_worker: "수행사 직원",
    designer: "디자이너",
    developer: "개발자",
    planner: "기획자",
    other: "기타",
